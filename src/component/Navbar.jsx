          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25h9.75m-9.75 0a2.25 2.25 0 0 0-2.25 2.25v.75h14.25v-.75a2.25 2.25 0 0 0-2.25-2.25m-9.75 0L4.5 5.25h14.625a1.125 1.125 0 0 1 1.08 1.44l-1.5 5.25a1.125 1.125 0 0 1-1.08.81H7.5Z"
              />
            </svg>
          </button>
        </Link>
